...
```
java -Dspring.profiles.active=production -jar ./target/bootify-keycloak-rest-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bootify-keycloak-rest
```
