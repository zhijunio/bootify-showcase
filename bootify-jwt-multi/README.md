...
project you have to select the highest module `bootify-jwt-multi-web` as the classpath.
...
```
java -Dspring.profiles.active=production -jar ./bootify-jwt-multi-web/target/bootify-jwt-multi-web-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bootify-jwt-multi
```
