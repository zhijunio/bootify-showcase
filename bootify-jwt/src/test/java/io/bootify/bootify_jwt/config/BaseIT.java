...
import io.bootify.bootify_jwt.BootifyJwtApplication;
 ...
 */
@SpringBootTest(
        classes = BootifyJwtApplication.class,
...
public abstract class BaseIT {
    ...
    public String jwtToken() {
        ...
        return "Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9." +
                "eyJzdWIiOiJ1c2VyIiwibG9naW5fdHlwZSI6ImRpcmVjdCIsInJvbGVzIjpbIlVTRVIiXSwiaXNzIjoiYm9vdGlmeSIsImlhdCI6MTc0Nzg3Mjk0NSwiZXhwIjoyMjA4OTg4ODAwfQ." +
                "XM7yi0y1VIjmOSVaYmqrE0tyNpLaFakRbtr3xwCQvYjYGOF9jwDlPI88TR6SvbHgH3MQTl9pxtMGuuC217-6aQ";
    }
