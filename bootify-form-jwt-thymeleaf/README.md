...
```
java -Dspring.profiles.active=production -jar ./target/bootify-form-jwt-thymeleaf-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bootify-form-jwt-thymeleaf
```
